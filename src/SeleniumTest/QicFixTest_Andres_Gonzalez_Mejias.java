...
public class QicFixTest_Andres_Gonzalez_Mejias {
	
	public QicFixTest_Andres_Gonzalez_Mejias()
	{
	  ...
	  public void sysTest001QicFixC402RegistrationSunny001() {
	    ...
	    driver.findElement(By.name("email")).sendKeys("steven.6@email.com");
	  ...
	  public void sysTest001QicFixC402RegistrationSunny002() {
	    ...
	    driver.findElement(By.name("email")).click();
	    driver.findElement(By.name("email")).sendKeys("miller.6@email.com");
	    driver.findElement(By.name("password")).click();
	    driver.findElement(By.name("password")).sendKeys("12345");
	  ...
	  /**  Author: Andres Gonzalez Mejias
		 * ID: SysTest-001-QicFix-CT-401-Tower Log in-Sunny001
		 ...
		 */
	  @Test
	  public void sysTest001QicFixCT401TowerLoginSunny001() {
		  //preconditions
	    driver.get("http://cen4072-fa20.cs.fiu.edu:8080/QicFixSystem-Geordi/login.jsp");
	    driver.manage().window().setSize(new Dimension(788, 824));
	    //input
	  ...
	  /**  Author: Andres Gonzalez Mejias
		 * ID: SysTest-001-QicFix-CT-401-Client Log in-Sunny002
       ...
       *
		 * Expected Output: client is not able to log in and a fail attempt is displayed
		 */
	  @Test
	  ...
	  /**  Author: Andres Gonzalez Mejias
		 * ID: SysTest-001-QicFix-CT-401- Client Log in-Sunny003
		 * Purpose: Evaluate functionality for client user not able to log in with false credentials
		 * Preconditions: 
		 *		 1-	For initial state of the database see Fig 4.1.2.1
		 *		 2-	The System is functioning properly
		 *	 	 3-	client user must be registered and in the database before being able to log in
     ...
     *
	  ...
	  public void sysTest001QicFixCT401ClientTowLoginSunny003() {	
	    ...
	    driver.findElement(By.id("inputEmail")).sendKeys("user1@email.com");
	    driver.findElement(By.id("inputPassword")).click();
	    driver.findElement(By.id("inputPassword")).sendKeys("586tDNE");
	    driver.findElement(By.cssSelector(".btn:nth-child(5)")).click();
	    //expected output
	    boolean contains = driver.getPageSource().contains("Logged as");
	    System.out.print(driver.getPageSource());
	  ...
	  /**  Author: Andres Gonzalez Mejias
		 * ID: SysTest-001-QicFix-CT-404- Client Log out-Sunny002
