...
public class DatastoreFacadeTest {
	 ...
	 * Purpose: Test if update client returns true or false
	 * Preconditions: A client instance is created
	 ...
	 * Preconditions: A client instance is created
	 * Input: client instance
	 * Expected output: Returns false if the client is updated
	 */
	@Test
	...
	// Compares two Client objects for equality
		public boolean compareClients(Client s1, Client s2){
			...
			return(s1.getId().equals(s2.getId()) &&
				   s1.getBlocked().equals(s2.getBlocked()) &&
				   s1.getCity().equals(s2.getCity()) &&
				   s1.getDob().equals(s2.getDob()) &&
				   s1.getEmail().equals(s2.getEmail()) &&
				   s1.getFname().equals(s2.getFname()) &&
				   s1.getLname().equals(s2.getLname()) &&
				   s1.getPassword().equals(s2.getPassword()) &&
				   s1.getPhone().equals(s2.getPhone()) &&
				   s1.getState().equals(s2.getState()) &&
				   s1.getStreetAddress().equals(s2.getStreetAddress()) &&
				   s1.getUserTypeId().equals(s2.getUserTypeId()) &&
		...
		private boolean compareTower(Tower s1, Tower s2) {
			return(s1.getId().equals(s2.getId()) &&
					   ...
					   s1.getUserTypeId().equals(s2.getUserTypeId()) &&
					   s1.getZipcode().equals(s2.getZipcode()) &&
					   s1.getCompanyName().equals(s2.getCompanyName()) &&
					   s1.getLatitude().equals(s2.getLatitude()) &&
					   s1.getLongitude().equals(s2.getLongitude()) &&
					   s1.getPermitNumber().equals(s2.getPermitNumber()) &&
					   s1.getPermitNumber().equals(s2.getPermitNumber()) &&
					   s1.getPriceMile().equals(s2.getPriceMile())	
				);
		}
