...
public class Tower extends User {
    ...
    public List<Tower> selectAll() {
        ...
        // ResultSet rs = null;
        //
        // sql = "SELECT t.id, t.email, t.company_name, t.permit_number, t.latitude,
        // t.longitude, t.price_mile, u.phone, u.user_type_id, u.fname, u.lname,
        // u.street_address, u.city, u.state, u.zipcode, u.dob, u.blocked"
        // + " FROM user u, tower t"
        ...
        if (createUser()) {
            ...
            try {
                ...
                db.getPreparedStatement().setDouble(++parameterIndex,
                        this.getLatitude() != null ? this.getLatitude() : Types.DOUBLE);
                db.getPreparedStatement().setDouble(++parameterIndex,
                        this.getLongitude() != null ? this.getLongitude() : Types.DOUBLE);
                db.getPreparedStatement().setDouble(++parameterIndex,
                        this.getPriceMile() != null ? this.getPriceMile() : Types.DOUBLE);
    ...
    public Tower selectById(Integer towerId) {
        ...
        sql = "SELECT t.id, t.email, t.company_name, t.permit_number, t.latitude, t.longitude, t.price_mile, u.phone, u.user_type_id, u.fname, u.lname, u.street_address, u.city, u.state, u.zipcode, u.dob, u.blocked"
                + " FROM user u, tower t" + " WHERE t.email=u.email AND t.id=" + towerId;
...
//        }.getType());
    ...
    public List<Tower> SelectByStateCity(Location location) {
        ...
        // Tower obj;
        //
        // sql = "SELECT t.id, t.email, t.company_name, t.permit_number, t.price_mile,
        // u.user_type_id, u.fname, u.lname, u.street_address, u.city, u.state,
        // u.zipcode, u.dob, u.blocked"
        // + " FROM user u, tower t"
        // + " WHERE t.email=u.email AND u.state='" + getState() + "' AND u.city='" +
        // getCity() + "'";
        //
        // //Database db = new Database();
        // Database db = Database.getInstance();
    ...
    List<Tower> SelectByRating() {
        ...
        //
        // sql = "SELECT t.id, t.email, t.company_name, t.permit_number, t.price_mile,
        // AVG(ht.tower_rating) as tower_rating,"
        // + " u.user_type_id, u.fname, u.lname, u.street_address, u.city, u.state,
        // u.zipcode, u.dob, u.blocked"
